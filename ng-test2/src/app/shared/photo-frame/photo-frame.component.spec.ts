...
describe(PhotoFrameComponent.name, () => {
    ...
    it(`#${PhotoFrameComponent.prototype.like.name} should trigger (@output liked) once when called
    ...
    it(`#${PhotoFrameComponent.prototype.like.name} should trigger (@Output like) two times when
